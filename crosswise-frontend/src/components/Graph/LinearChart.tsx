...
const LinearChart = ({ data, setHoverValue, setHoverDate, preTicker, suffTicker }: LinearChartProps) => {
          ...
          <ChartValueContainer>
            <Text fontSize="11px" fontWeight={600} color="primaryText">
              ...
              <span style={{ fontSize: '16px', fontWeight: 700 }}>
                {preTicker} {date[0]?.value} {suffTicker || ''}
              </span>
            </Text>
            <Text fontSize="11px" fontWeight={600} color="primaryText">
              VOL:&nbsp;
              <span style={{ fontSize: '16px', fontWeight: 700 }}>
                {preTicker} {date[0]?.payload.volume} {suffTicker || ''}
              </span>
            </Text>
          </ChartValueContainer>
        </ChartContentContainer>
