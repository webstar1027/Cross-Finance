...
import { Text, Button, CloseIcon, IconButton, LinkExternal, Input, Link } from '@crosswiselabs/uikit'
...
import { ManageTokenWrapper as Wrapper, ManageTokenFooter as Footer } from './styled'
