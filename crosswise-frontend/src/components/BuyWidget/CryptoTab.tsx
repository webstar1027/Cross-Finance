...
import { PreTitle, SmallCopy } from 'style/typography'
...
const CryptoTab = ({ onFocus }: CryptoTabProps) => {
    ...
    <>
      ...
      <Box>
        ...
        <Flex justifyContent="space-between" alignItems="center" py="12px">
          <SmallCopy color="textSecondary" width="140px">
        ...
        <Box py="12px">
          <SmallCopy color="textSecondary" minHeight="15px">
      ...
      <Box mb="40px">
        {swapIsUnsupported ? (
          ...
          <WarningPad>
            <PreTitle color="failure">{t('Insufficient liquidity for this trade.')}</PreTitle>
            {singleHopOnly && (
              <PreTitle color="failure" mt="4px">
