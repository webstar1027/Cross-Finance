...
// import { Text, Toggle, Flex } from '@crosswiselabs/uikit'
import { Text, Flex, useModal } from '@crosswiselabs/uikit'
    ...
    <ColumnWrap>
      <Container expanded={expanded}>
        <InfoContainer>
          ...
          <StyledLinkExternal href={bsc}>{t('Price Impact')}</StyledLinkExternal>
          <StyledLinkExternal href={info}>{t('Swap Fee')}</StyledLinkExternal>
        </InfoContainer>
        {/* <ValueContainer>
          <ValueWrapper>
            <Text>{t('APR')}</Text>
        ...
        <EarnPanel>
          <Flex flexDirection="column" justifyContent="center" alignItems="center">
            ...
            <Text fontSize="17px" mr="24px">
              {/* {insertThousandSeparator(CrssTokenEarned?.toFixed(2))} */}
              {displayBalance}
            </Text>
            <Text fontSize="13px" mr="24px" color="primaryGray">
