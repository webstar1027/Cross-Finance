...
import { Button, Text, AddIcon, ArrowDownIcon, CardBody, Slider, Box, Flex, useModal } from '@crosswiselabs/uikit'
...
export default function RemoveLiquidity({
  ...
  const renderContent = () => <ConfirmationModalContent topContent={modalHeader} bottomContent={modalBottom} />
