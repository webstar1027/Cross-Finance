...
import { CardRibbon, ExpandableButton, Progress, Button, ChevronUpIcon } from '@crosswiselabs/uikit'
...
import { StyledCard, Header, FoldableContent, CardsWrapper, StyledCardBody, StyledCardFooter } from './styled'
