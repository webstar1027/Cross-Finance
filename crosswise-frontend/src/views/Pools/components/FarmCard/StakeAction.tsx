...
import { Button, AddIcon, MinusIcon, useModal } from '@crosswiselabs/uikit'
...
const StakeAction: React.FC<FarmCardActionsProps> = ({
  ...
  const [onPresentDeposit] = useModal(
    <DepositModal max={tokenBalance} onConfirm={handleStake} tokenName={tokenName} addTokenUrl={addLiquidityUrl} />,
  )
