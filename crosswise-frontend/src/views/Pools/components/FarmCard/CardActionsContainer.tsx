...
import { Flex, Toggle, useModal } from '@crosswiselabs/uikit'
...
const CardActions: React.FC<FarmCardActionsProps> = ({ isCollapsed, farm, account, addTokenUrl }) => {
  ...
  const [onPresentDeposit] = useModal(
    <DepositModal max={tokenBalance} onConfirm={handleStake} tokenName={farm.lpSymbol} addTokenUrl={addTokenUrl} />,
  )
